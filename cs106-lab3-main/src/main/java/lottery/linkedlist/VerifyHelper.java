...
/*
 * @author CS106 TA
 * Does the heavy lifting of the Verify work.
 * 
 * Specific CSV files should extend this class, call super() constructor,
 * and add test cases using addTestCase() in their constructor.
 * It should then create an instance of its own class, and call run().
 * 
